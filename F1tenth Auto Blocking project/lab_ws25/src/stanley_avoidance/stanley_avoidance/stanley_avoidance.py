...
class StanleyAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter("waypoints_path", "/home/f1tenth/lab_ws25/src/stanley_avoidance/racelines/FTM_clean2_ws25.csv")
        self.declare_parameter("waypoints_path_2nd", "/home/f1tenth/lab_ws25/src/stanley_avoidance/racelines/FTM_clean2_ws25.csv")
        ...
        self.declare_parameter("K_p", 4)
        self.declare_parameter("K_i", 0.3)
        self.declare_parameter("K_d", 0.12)
        self.declare_parameter("K_p_obstacle", 0.8)
        self.declare_parameter("K_E", 1.0)
        self.declare_parameter("K_H", 0.3)
        self.declare_parameter("crosstrack_error_offset", -0.1)
